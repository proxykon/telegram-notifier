...
final class TelegramOptions implements MessageOptionsInterface
{
     ...
     * @return $this
     */
    public function uploadDocument(string $path, string $fileName, string $mimeType = 'text/plain'): static
    {
        $this->options['upload']['document']['path'] = $path;
        $this->options['upload']['document']['fileName'] = $fileName;
        $this->options['upload']['document']['mimeType'] = $mimeType;
        return $this;
    }
